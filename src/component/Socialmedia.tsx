  ...
  return (
    ...
    <section>
      ...
      <div className=" md:flex flex-row  md:p-10">
        <div className="image">
          <a className="relative block w-500 h-700 bg-gray-900 group" href="##">
            <img
            ...
            <div className="relative p-5">
              <div className="mt-8 ml-24">
                ...
                >
                  <div className="p-2">
                    <h4 className="text-lg text-white">Faction</h4>
                    <a
                      href="#"
          ...
          <a className="relative block w-500 h-700 bg-gray-900 group" href="##">
            ...
            <div className="relative p-5">
              <div className="mt-8 ml-24">
                ...
                >
                  <div className="p-2">
                    <h4 className="text-lg text-white">New</h4>
                    <a
                      href="#"
                      className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400"
                    >
          ...
          <a className="relative block w-500 h-700 bg-gray-900 group" href="##">
            ...
            <div className="relative p-5">
              <div className="mt-8 ml-24">
                ...
                >
                  <div className="p-2">
                    <h4 className="text-lg text-white">Brand</h4>
                    <a
                      href="#"
                      className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400"
                    >
          ...
          <a className="relative block w-500 h-700 bg-gray-900 group" href="##">
            ...
            <div className="relative p-5">
              <div className="mt-8 ml-24">
                ...
                >
                  <div className="p-2">
                    <h4 className="text-lg text-white">Makeup</h4>
                    <a
                      href="#"
                      className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400"
                    >
          ...
          <a className="relative block w-500 h-700 bg-gray-900 group" href="##">
            ...
            <div className="relative p-5">
              <div className="mt-8 ml-24">
                ...
                >
                  <div className="p-2">
                    <h4 className="text-lg text-white">Leather</h4>
                    <a
                      href="#"
                      className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400"
                    >
          ...
          <a className="relative block w-500 h-700 bg-gray-900 group" href="##">
            ...
            <div className="relative p-5">
              <div className="mt-8 ml-24">
                ...
                >
                  <div className="p-2">
                    <h4 className="text-lg text-white">Bag</h4>
                    <a
                      href="#"
                      className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400"
                    >
