...
export default function Scrollkid() {
  ...
  const women = [
    {
        id:1,
        image01:"./images/women-01.jpg",
        name:"New Green Jacket",
        price:"$75.00"
    },
    {   id:2,
        image01:"./images/women-02.jpg",
        name:"Classic Dress",
        price:"$45.00"
    },
    {   id:3,
        image01:"./images/women-03.jpg",
        name:"Spring Collection",
        price:"$130.00"
}
]

const WomensData = women.map(item=>(<CardData imageurl={item.image01} name={item.name} price={item.price}/>))
              ...
              <div className="row p-10">
                <div className="col-lg-12">
                  <div className="section-heading">
                    <h2 className="text-5xl font-bold py-5">Women'S Latest</h2>
